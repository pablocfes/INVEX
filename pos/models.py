...
class Company(models.Model):
    ...
    mobile = models.CharField(max_length=100, verbose_name='Teléfono celular')
    ...
    iva = models.DecimalField(default=19.0, decimal_places=2, max_digits=9, verbose_name='Iva')
...
class Provider(models.Model):
    ...
    nit = models.CharField(max_length=13, unique=True, verbose_name='Nit')
