...
from pos.choices import PAYMENT_CONDITION
from pos.forms import PurchaseForm, Purchase, PurchaseDetail, Product, Provider, DebtsPay, ProviderForm
        ...
        try:
            if action == 'add':
                ...
                if pattern == 'name':
                    ...
                    data['valid'] = not queryset.filter(nit=parameter).exists()
                elif pattern == 'mobile':
