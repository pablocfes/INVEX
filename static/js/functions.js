...
function validate_dni_ruc(dni) {
    ...
    if (pub == true) {
        if (digitoVerificador != d9) {
            //alert('El nit de la empresa del sector público es incorrecto.');
            return false;
        }
        /* El nit de las empresas del sector publico terminan con 0001*/
        if (dni.substr(9, 4) != '0001') {
            //alert('El nit de la empresa del sector público debe terminar con 0001');
            return false;
        }
    } else if (pri == true) {
        if (digitoVerificador != d10) {
            //alert('El nit de la empresa del sector privado es incorrecto.');
            return false;
        }
        if (dni.substr(10, 3) != '001') {
            //alert('El nit de la empresa del sector privado debe terminar con 001');
            return false;
        }
    } else if (nat == true) {
        if (digitoVerificador != d10) {
        ...
        if (dni.length > 10 && dni.substr(10, 3) != '001') {
            //alert('El nit de la persona natural debe terminar con 001');
            return false;
        }
    }
    return true;
